...
import br.senac.sp.modelo.Produto;
 ...
 */
@WebServlet(name = "controllerPessoa", urlPatterns = {"/produto"})
public class controllerProduto extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
         System.out.println("teste: " +   request.getParameter("codigo"));
        request.setAttribute("msg", "Lista de produtos atualizada");
...
//        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        produto.setPreço(Long.parseLong(request.getParameter("preco")));
